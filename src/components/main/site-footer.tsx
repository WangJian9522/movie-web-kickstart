...
const SiteFooter = () => {
  return (
    <footer aria-label="Footer" className="w-full">
      ...
      {/*</div>*/}
      {/* </div> */}
      <div className="container items-center px-8 py-5">
        <p className="mb-2 text-lg font-semibold text-foreground/80">
          {siteConfig.author}
        </p>
        ...
        <p className="text-sm text-foreground/70">contact@tubiii.com</p>
      </div>
    </footer>
  );
};
